...
<head>
    ...
    <link href="{{{ HTML::amazonCloudfront('assets/global/plugins/font-awesome/css/font-awesome.min.css') }}}" rel="stylesheet" type="text/css"/>
    <link href="{{{ HTML::amazonCloudfront('assets/global/plugins/simple-line-icons/simple-line-icons.min.css') }}}" rel="stylesheet"
          type="text/css"/>
